...
#include "..\\YamYamEngine_SOURCE\\YGraphicDevice_DX11.h"
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, // 프로그램 인스턴스 핸들
                     ...
                     _In_ int       nCmdShow) // 프로그램이 실행될 형태, 보통 모양정보등이 전달
{
    ...
    yam::graphics::GraphicDevice_DX11*& graphicdevice = yam::graphics::GetDevice();
